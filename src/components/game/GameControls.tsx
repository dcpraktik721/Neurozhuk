...
export default function GameControls({
  ...
  const sectionLabelClassName = 'text-[13px] text-white uppercase tracking-[0.14em] mb-2.5 font-bold';
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-4 space-y-4">
      ...
      <div>
        <p className={sectionLabelClassName}>Режим игры</p>
      ...
      {/* Difficulty selector */}
      <div>
        <p className={sectionLabelClassName}>Сложность</p>
          ...
          <button
            ...
            className={`w-full px-3 py-2 rounded-lg text-xs font-medium transition-all text-left ${
              difficultyMode === 'easy'
                ...
                : 'bg-slate-900/40 border border-slate-700/50 text-slate-200 hover:text-white'
            } disabled:opacity-60`}
          >
            🟢 Легкий (с подсказкой)
          </button>
      ...
      {/* Music toggle */}
      <div>
        <p className={sectionLabelClassName}>Музыка</p>
        <button
      ...
      <div className="pt-2 border-t border-slate-700/50">
        <div className="flex items-center gap-1.5 text-slate-200 mb-2.5">
          ...
          <span className="text-[13px] font-bold uppercase tracking-[0.14em] text-white">Управление</span>
        </div>
        <div className="space-y-1">
          <div className="flex justify-between text-xs">
            <span className="text-white">Движение</span>
